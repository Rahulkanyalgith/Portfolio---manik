...
const Navbar = ({modeHandler, theme}) => {
    ...
    return (
        <div className='w-[100%] fixed bottom-0 left-0 z-[1000] dark:bg-[#1f1627] bg-[#fdfbfe] md:py-0 md:px-[1rem] md:top-0 md:bottom-[initial] shadow-[0_-1px_4px_rgba(0,0,0,0.15)] dark:shadow-purple-700/50'>
            <nav className='max-w-[968px] h-[3rem] flex justify-between items-center ml-[1.5rem] mr-[1.5rem] md:h-[4.5rem] md:gap-x-[1rem] md:mx-auto md:text-center md:justify-between'>
                ...
                <div className='md:flex md:items-center md:gap-[0.8rem] md:justify-center'>
                    <div className={`fixed bottom-0 left-0 w-[100%] dark:bg-[#1f1627] bg-[#fdfbfe] pt-[2rem] pr-[1.5rem] pl-[1.5rem] pb-[4rem] dark:shadow-purple-700/50 shadow-[0_-1px_4px_rgba(0,0,0,0.15)] rounded-t-3xl transition-all duration-[.3s] md:block md:top-0 md:bottom-[initial] md:bg-transparent md:py-[1.5rem] md:h-[4.5rem] md:text-center md:shadow-none md:px-0 md:relative ${ toggle ? "hidden" : "block"}`}>
                        ...
                        <FaTimes className='absolute right-[1.3rem] bottom-[1.5rem] text-[1.5rem] cursor-pointer text-[#9234ea] hover:text-[#7d26cf] dark:hover:text-[#9234ea] md:hidden' onClick={changeToggleHandler}/>
                    </div>
